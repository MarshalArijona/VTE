...
class VTEInfoNCE2(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        samples_zhat = zhat.repeat(repeats=(batch_size, 1))
        samples_z = torch.repeat_interleave(z, repeats=batch_size, dim=0)
        
        feature = torch.cat((samples_z, samples_zhat), 1)
        product = self.linear(feature)
